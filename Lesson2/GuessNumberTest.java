...
public class GuessNumberTest {
    ...
    public static void main(String[] args) {
        ...
        do {
            System.out.println("GENERATE NUMBER " + GuessNumber.generateNumber());
    ...
    public void enterNumberPlayer1() {
        do {
            ...
            if (numberScanPlayer1 < GuessNumber.getComputerNumber()) {
                System.out.println("Player 1 entered number < the number of computer.");
            } else if (numberScanPlayer1 > GuessNumber.getComputerNumber()) {
                System.out.println("Player 1 entered number > the number of computer");
            } else if (numberScanPlayer1 == GuessNumber.getComputerNumber()) {
    ...
    public void enterNumberPlayer2() {
        do {
            ...
            if (numberScanPlayer2 < GuessNumber.getComputerNumber()) {
                System.out.println("Player 2 entered number < the number of computer.");
            } else if (numberScanPlayer2 > GuessNumber.getComputerNumber()) {
                System.out.println("Player 2 entered number > the number of computer");
            } else if (numberScanPlayer2 == GuessNumber.getComputerNumber()) {
